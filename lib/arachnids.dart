...
class arachnidsScreen extends StatefulWidget {
  const arachnidsScreen({super.key});

  @override
  _arachnidsScreenState createState() => _arachnidsScreenState();
}

class _arachnidsScreenState extends State<arachnidsScreen> {
  List<Map<String, dynamic>> arachnidData = [];
  ...
  Future<void> loadarachnidData() async {
    try {
      ...
      List<Map<String, dynamic>> arachnids = data
          .where((species) =>
                ...
                child: isLoading
                    ...
                    : arachnidData.isEmpty
                        ...
                        : GridView.builder(
                            ...
                            itemCount: arachnidData.length,
                            itemBuilder: (context, index) {
                              final arachnid = arachnidData[index];
                                  ...
                                  children: [
                                    Expanded(
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(
                                          arachnid["headerImage"] ?? 'assets/placeholder.jpg',
                                          fit: BoxFit.cover,
                                    ...
                                    Text(
                                      arachnid["name"] ?? "Unknown arachnid",
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: BottomNavigationBar(
                  currentIndex: 1, // Highlight arachnids tab
